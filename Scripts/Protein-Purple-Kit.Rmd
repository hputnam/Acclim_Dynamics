...
```{r}
prot.mcap <- prot %>% subset(Species == "Mcapitata") %>% subset(Timepoint == "1 week" | Timepoint == "2 week" | Timepoint == "4 week" | Timepoint == "6 week" | Timepoint == "8 week" | Timepoint == "12 week" | Timepoint == "16 week")
...
tab_model(Pacuta_prot_LMER, Mcap_prot_LMER,
          dv.labels = c("P.acuta protein", "M. capitata protein"), string.ci = "Conf. Int (95%)",
          string.p = "P-Value", file = "Output/Statistics/Protein.doc")

capture.output(pacuta.prot.anova, file = "Output/Statistics/Protein_Pacuta.txt")
capture.output(mcap.prot.anova, file = "Output/Statistics/Protein_Mcap.txt")
```
