...
9-10 protein plate with each one containing a standard curve. 
...
prot <- df %>%
  ...
  filter(Plug_ID != "BK") %>%                                 # Filter out blank wells
...
filter(prot, Timepoint == "6 week" & Species == "Mcapitata" & Treatment == "HTHC")
