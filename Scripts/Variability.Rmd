...
ggsave(file="Output/Final_Figures/MAD-Chl.png", Chl, width = 11, height = 6, units = c("in"))
```
...
ggsave(file="Output/Final_Figures/MAD-Prot-TAC.png", ProtTAC, width = 11, height = 6, units = c("in"))
```
...
ggsave(file="Output/Final_Figures/MAD-AFDW.png", AFDW, width = 11, height = 6, units = c("in"))
```
