...
```{r}
cols <- c("darkgreen", "lightgreen", "firebrick1", "darkgoldenrod2", "gold")

ggplot(data = denoising.stats.gathered, aes(x = parameter, y = value, group = parameter, color = parameter)) +
