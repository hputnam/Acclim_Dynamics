...
ggplot(denoise.final.reads, aes(x=measurement, y=value), group = type) + geom_boxplot() + ylab("# reads") + theme_bw()
ggplot(denoise.final.percent, aes(x=measurement, y=value), group = type) + geom_boxplot() + ylab("% reads") + theme_bw()
```
