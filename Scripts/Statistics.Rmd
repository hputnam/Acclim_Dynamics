...
ggsave(file="Output/Final_Figures/Poc-stress-PCAs.pdf", Pacuta.stress.PCAs, width = 10, height = 6, units = c("in"))
ggsave(file="Output/Final_Figures/Poc-stress-PCAs.png", Pacuta.stress.PCAs, width = 10, height = 6, units = c("in"))
```
