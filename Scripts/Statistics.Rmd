...
Pacuta_acute_phase <- autoplot(Pacuta_acute_PCA, data = P_acute_data, colour = 'Treatment',
  ...
  xlim(-0.225,0.5) + scale_color_manual(values = cols) + scale_fill_manual(values = cols) + ggtitle("P. acuta; Acute Stress"); Pacuta_acute_phase
...
Mcap_acute_phase <- autoplot(Mcap_acute_PCA, data = M_acute_data, colour = 'Treatment',
  ...
  theme(legend.position = "none") + 
  #xlim(-0.225,0.5) + 
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) + ggtitle("M. capitata; Acute Stress"); Mcap_acute_phase
```
...
Pacuta_chronic_phase <- autoplot(Pacuta_chronic_PCA, data = P_chronic_data, colour = 'Treatment',
  ...
  theme(legend.position = "none") + 
  #xlim(-0.225,0.5) + 
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) + ggtitle("P. acuta; Chronic Stress"); Pacuta_chronic_phase
...
Mcap_chronic_phase <- autoplot(Mcap_chronic_PCA, data = M_chronic_data, colour = 'Treatment',
  ...
  theme(legend.position = "none") +
  #xlim(-0.225,0.5) + 
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) + ggtitle("M. capitata; Chronic Stress"); Mcap_chronic_phase
```
...
Pacuta_recovery_phase <- autoplot(Pacuta_recovery_PCA, data = P_recovery_data, colour = 'Treatment',
  ...
  theme(legend.position = "none") + 
  #xlim(-0.225,0.5) + 
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) + ggtitle("P. acuta; Recovery"); Pacuta_recovery_phase
...
Mcap_recovery_phase <- autoplot(Mcap_recovery_PCA, data = M_recovery_data, colour = 'Treatment',
  ...
  theme(legend.position = "none") + 
  #xlim(-0.225,0.5) + 
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) + ggtitle("M. capitata; Recovery"); Mcap_recovery_phase
