...
ggsave(file="Output/Final_Figures/PCA-stress.pdf", Stress.PCAs, width = 4, height = 10, units = c("in"))
ggsave(file="Output/Final_Figures/PCA-stress.png", Stress.PCAs, width = 4, height = 10, units = c("in"))
```
...
ggsave(file="Output/Final_Figures/PCA-timeseries.pdf", Timeseries.PCAs, width = 4, height = 10, units = c("in"))
ggsave(file="Output/Final_Figures/PCA-timeseries.png", Timeseries.PCAs, width = 4, height = 10, units = c("in"))
```
