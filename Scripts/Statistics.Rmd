...
## checking homogeneity of variance using levene test (can also use Bartlett's test function)
leveneTest(Pacuta_stress_data$Host_AFDW.mg.cm2 ~ Pacuta_stress_data$Timepoint*Pacuta_stress_data$Temperature*Pacuta_stress_data$CO2)
...
```{r}
## Sym
Pacuta_Sym_LMER <- lmer(Sym_AFDW.mg.cm2 ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=Pacuta_stress_data) #GLMM
# GAM 
# anova(GLMM, GAM) # report AIC values
...
## checking homogeneity of variance using levene test (can also use Bartlett's test function)
leveneTest(Pacuta_stress_data$Sym_AFDW.mg.cm2 ~ Pacuta_stress_data$Timepoint*Pacuta_stress_data$Temperature*Pacuta_stress_data$CO2)
...
```{r}
## S:H Ratio 
Pacuta_SHRatio_LMER <- lmer(log(Ratio_AFDW.mg.cm2) ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=Pacuta_stress_data) #GLMM
# GAM 
# anova(GLMM, GAM) # report AIC values
...
## checking homogeneity of variance using levene test (can also use Bartlett's test function)
leveneTest(Pacuta_stress_data$Ratio_AFDW.mg.cm2 ~ Pacuta_stress_data$Timepoint*Pacuta_stress_data$Temperature*Pacuta_stress_data$CO2)
...
```{r}
## Pacuta 
Pacuta_prot_LMER <- lmer(prot_mg.cm2 ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=Pacuta_stress_data) #GLMM
# GAM 
# anova(GLMM, GAM) # report AIC values
...
## checking homogeneity of variance using levene test (can also use Bartlett's test function)
leveneTest(Pacuta_stress_data$prot_mg.cm2 ~ Pacuta_stress_data$Timepoint*Pacuta_stress_data$Temperature*Pacuta_stress_data$CO2)
...
```{r}
## Pacuta 
Pacuta_TAC_LMER <- lmer(log(cre.umol.mgprot) ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=Pacuta_stress_data) #GLMM
# GAM 
# anova(GLMM, GAM) # report AIC values
...
## checking homogeneity of variance using levene test (can also use Bartlett's test function)
leveneTest(Pacuta_stress_data$cre.umol.mgprot ~ Pacuta_stress_data$Timepoint*Pacuta_stress_data$Temperature*Pacuta_stress_data$CO2) 
