...
## Host 
Pacuta_Host_LMER <- lmer(Host_AFDW.mg.cm2 ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=pacuta_full_data) 
Pacuta_Host_LMER.reef <- lmer(Host_AFDW.mg.cm2 ~ Timepoint*Temperature*CO2 + (1|Tank) + (1|Site.Name), na.action=na.omit, data=pacuta_full_data)
...
```{r}
## Sym
Pacuta_Sym_LMER <- lmer(Sym_AFDW.mg.cm2 ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=pacuta_full_data) 
Pacuta_Sym_LMER.reef <- lmer(Sym_AFDW.mg.cm2 ~ Timepoint*Temperature*CO2 + (1|Tank) + (1|Site.Name), na.action=na.omit, data=pacuta_full_data)
...
Anova(Pacuta_Sym_LMER.reef, ddf="lme4", type='III') 

## Type III Analysis of Variance Table with Satterthwaite's method
anova(Pacuta_Sym_LMER, ddf="Satterthwaite", type='III') 
anova(Pacuta_Sym_LMER.reef, ddf="Satterthwaite", type='III') 
```
...
Pacuta_SHRatio_LMER.reef <- lmer(log(Ratio_AFDW.mg.cm2) ~ Timepoint*Temperature*CO2 + (1|Tank) + (1|Site.Name), na.action=na.omit, data=pacuta_full_data)
...
## Type III Analysis of Variance Table with Satterthwaite's method
anova(Pacuta_SHRatio_LMER, ddf="Satterthwaite", type='III') 
```
...
```{r}
## Host 
Mcap_Host_LMER <- lmer(Host_AFDW.mg.cm2 ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=mcap_full_data) 
Mcap_Host_LMER.reef <- lmer(Host_AFDW.mg.cm2 ~ Timepoint*Temperature*CO2 + (1|Tank) + (1|Site.Name), na.action=na.omit, data=mcap_full_data)
...
## Type III Analysis of Variance Table with Satterthwaite's method
anova(Mcap_Host_LMER, ddf="Satterthwaite", type='III') 
```

Sym AFDW. 
```{r}
## Sym
Mcap_Sym_LMER <- lmer(Sym_AFDW.mg.cm2 ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=mcap_full_data) 
Mcap_Sym_LMER.reef <- lmer(Sym_AFDW.mg.cm2 ~ Timepoint*Temperature*CO2 + (1|Tank) + (1|Site.Name), na.action=na.omit, data=mcap_full_data)
...
## Type III Analysis of Variance Table with Satterthwaite's method
anova(Mcap_Sym_LMER, ddf="Satterthwaite", type='III') 
```
