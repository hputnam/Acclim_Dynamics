...
# "cornflowerblue", "darkblue", "firebrick1", "darkred"
```
...
Stress.PCAs <- arrangeGrob(Mcap_group, Pacuta_group, ncol=2)
ggsave(file="Output/Final_Figures/PCA-stress.pdf", Stress.PCAs, width = 10, height = 4, units = c("in"))
ggsave(file="Output/Final_Figures/PCA-stress.png", Stress.PCAs, width = 10, height = 4, units = c("in"))
```
...
Pacuta_timeseries_phase <- autoplot(Pacuta_scaled_timeseriesdata, data = Pacuta_timeseriesdata, colour = 'Phase',
         loadings = TRUE, loadings.colour = 'black', frame=TRUE, size=0.5, frame.type = 'convex',
         loadings.label = TRUE, loadings.label.size = 3, loadings.label.colour = 'black', loadings.label.vjust=-1) + theme_bw() +
  #xlim(-0.225,0.2) + 
  scale_colour_brewer() + ggtitle("P. acuta"); Pacuta_timeseries_phase
...
Pacuta.timeseries.PCAs <- arrangeGrob(Pacuta_timeseries_treatment, Pacuta_timeseries_timepoint, Pacuta_timeseries_phase, ncol=2)
ggsave(file="Output/Final_Figures/Pacuta-Timeseries-PCAs.pdf", Pacuta.timeseries.PCAs, width = 10, height = 8, units = c("in"))
ggsave(file="Output/Final_Figures/Pacuta-Timeseries-PCAs.png", Pacuta.timeseries.PCAs, width = 10, height = 8, units = c("in"))
```
...
Mcap_timeseries_phase <- autoplot(Mcap_scaled_timeseriesdata, data = Mcap_timeseriesdata, colour = 'Phase',
         loadings = TRUE, loadings.colour = 'black', frame=TRUE, size=0.5, frame.type = 'convex',
         loadings.label = TRUE, loadings.label.size = 3, loadings.label.colour = 'black', loadings.label.vjust=-1) + theme_bw() +
  #xlim(-0.225,0.13) + 
  scale_colour_brewer() + ggtitle("M. capitata"); Mcap_timeseries_phase
...
Mcap.timeseries.PCAs <- arrangeGrob(Mcap_timeseries_treatment, Mcap_timeseries_timepoint, Mcap_timeseries_phase, ncol=2)
ggsave(file="Output/Final_Figures/Mcap-Timeseries-PCAs.pdf", Mcap.timeseries.PCAs, width = 10, height = 8, units = c("in"))
ggsave(file="Output/Final_Figures/Mcap-Timeseries-PCAs.png", Mcap.timeseries.PCAs, width = 10, height = 8, units = c("in"))
```
