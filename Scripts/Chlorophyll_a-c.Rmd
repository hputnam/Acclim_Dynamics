...
# Load homogenate volume
homog.vol <- read_csv("Physiology_variables/Physiology_Master.csv") %>%
...
df.chl %>%
  select(Plug_ID, chla.ug.cm2, chlc2.ug.cm2) %>%
...
Master_fragment$colony_id <- as.character(Master_fragment$Plug_ID)
