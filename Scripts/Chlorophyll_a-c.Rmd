...
Mcap_chl <- Chl_final %>% subset(Species == "Mcapitata") %>% 
  subset(Timepoint == "1 week" | Timepoint == "2 week" | Timepoint == "4 week" | Timepoint == "6 week" | Timepoint == "8 week" | Timepoint == "12 week" | Timepoint == "16 week" )
...
capture.output(pacuta.chl.a.anova, file = "Output/Statistics/Chla_Pacuta.txt")
capture.output(pacuta.chl.c2.anova, file = "Output/Statistics/Chlc2_Pacuta.txt")
capture.output(pacuta.chl.a.cells.anova, file = "Output/Statistics/Chla_cells_Pacuta.txt")
capture.output(pacuta.chl.c2.cells.anova, file = "Output/Statistics/Chlc2_cells_Pacuta.txt")
```
...
tab_model(Mcap_Chl_LMER_a, Mcap_Chl_LMER_c2,
          ...
          string.p = "P-Value", file = "Output/Statistics/Chl_Mcap.doc")

capture.output(mcap.chl.a.anova, file = "Output/Statistics/Chla_Mcap.txt")
capture.output(mcap.chl.c2.anova, file = "Output/Statistics/Chlc2_Mcap.txt")
```
