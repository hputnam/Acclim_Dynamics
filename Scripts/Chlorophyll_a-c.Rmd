...
Chl_means <- Chl_means %>% subset(!Timepoint == "Day 1" & !Timepoint == "Day 2" & !Timepoint == "12 week" & !Timepoint == "16 week") %>%
...
CHL.cm2 <- ggplot(Chl_means_cm2, aes(x=Timepoint, y = Value, group = Treatment, color = Treatment)) +
 ...
 # geom_vline(xintercept = c(5.2), colour="black", linetype="dotted") +
  ...
  # Change axis line
  axis.line = element_line(colour = "black")); CHL.cm2
...
CHL.cells<- ggplot(Chl_means_cells, aes(x=Timepoint, y = Value, group = Treatment, color = Treatment)) +
  ...
  xlab("") + 
  theme_classic() + 
  ylab(expression("Chlorophyll a" ~(ug ~cells^-1))) +
  #ggtitle("Chlorophyll a and c2 concentration") +
 ...
 # geom_vline(xintercept = c(5.2), colour="black", linetype="dotted") +
  ...
  strip.text.x = element_text(size = 12, color = "black", face = "bold.italic"),
  # Change axis line
  axis.line = element_line(colour = "black")); CHL.cells

ggsave(file="Output/Final_Figures/Chlorophyll_SA.pdf", CHL.cm2, width = 11, height = 6, units = c("in"))
ggsave(file="Output/Final_Figures/Chlorophyll_SA.png", CHL.cm2, width = 11, height = 6, units = c("in"))
ggsave(file="Output/Final_Figures/Chlorophyll_cells.pdf", CHL.cells, width = 11, height = 6, units = c("in"))
ggsave(file="Output/Final_Figures/Chlorophyll_cells.png", CHL.cells, width = 11, height = 6, units = c("in"))
```
...
```{r}
Mcap_chl <- Chl_final %>% subset(Species == "Mcapitata") %>% 
  subset(Timepoint == "1 week" | Timepoint == "2 week" | Timepoint == "4 week" | Timepoint == "6 week" | Timepoint == "8 week")

Mcap_chl_recovery <- Chl_final %>% subset(Species == "Mcapitata") %>% 
  subset(Timepoint == "12 week" | Timepoint == "16 week" )

Pacuta_chl <- Chl_final %>% subset(Species == "Pacuta") %>% subset(Timepoint == "1 week" | Timepoint == "2 week" | Timepoint == "4 week" | Timepoint == "6 week" | Timepoint == "8 week")
...
```{r}
## Chlorophyll a
Pacuta_Chl_LMER_a <- lmer(log(chla.ug.cm2) ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=Pacuta_chl)
Pacuta_Chl_LMER_a_cells <- lmer(log(chla.ug.cells) ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=Pacuta_chl)
## Chlorophyll c2
Pacuta_Chl_LMER_c2 <- lmer(chlc2.ug.cm2 ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=Pacuta_chl)
Pacuta_Chl_LMER_c2_cells <- lmer(log(chlc2.ug.cells) ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=Pacuta_chl)

qqPlot(residuals(Pacuta_Chl_LMER_a)) 
qqPlot(residuals(Pacuta_Chl_LMER_a_cells)) 
qqPlot(residuals(Pacuta_Chl_LMER_c2)) 
qqPlot(residuals(Pacuta_Chl_LMER_c2_cells)) 

hist(residuals(Pacuta_Chl_LMER_a))
hist(residuals(Pacuta_Chl_LMER_a_cells)) 
hist(residuals(Pacuta_Chl_LMER_c2)) 
hist(residuals(Pacuta_Chl_LMER_c2_cells)) 

## Type III Wald chisquare tests
pacuta.chl.a.anova <- Anova(Pacuta_Chl_LMER_a, ddf="lme4", type='III')
pacuta.chl.c2.anova <- Anova(Pacuta_Chl_LMER_c2, ddf="lme4", type='III')
pacuta.chl.a.cells.anova <- Anova(Pacuta_Chl_LMER_a_cells, ddf="lme4", type='III')
pacuta.chl.c2.cells.anova <- Anova(Pacuta_Chl_LMER_c2_cells, ddf="lme4", type='III')

tab_model(Pacuta_Chl_LMER_a, Pacuta_Chl_LMER_c2,
          dv.labels = c("P.acuta chl-a", "P.acuta chl-c2"), string.ci = "Conf. Int (95%)",
          string.p = "P-Value", file = "Output/Statistics/Chl_Pacuta.doc")
tab_model(Pacuta_Chl_LMER_a_cells, Pacuta_Chl_LMER_c2_cells,
          dv.labels = c("P.acuta chl-a cells", "P.acuta chl-c2 cells"), string.ci = "Conf. Int (95%)",
          string.p = "P-Value", file = "Output/Statistics/Chl_cells_Pacuta.doc")

capture.output(pacuta.chl.a.anova, file = "Output/Statistics/Stress_statistics/Chla_cm2_Pacuta.txt")
capture.output(pacuta.chl.c2.anova, file = "Output/Statistics/Stress_statistics/Chlc2_cm2_Pacuta.txt")
capture.output(pacuta.chl.a.cells.anova, file = "Output/Statistics/Stress_statistics/Chla_cells_Pacuta.txt")
capture.output(pacuta.chl.c2.cells.anova, file = "Output/Statistics/Stress_statistics/Chlc2_cells_Pacuta.txt")
```
...
Mcap_Chl_LMER_a <- lmer(chla.ug.cm2 ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=Mcap_chl)
Mcap_Chl_LMER_c2 <- lmer(chlc2.ug.cm2 ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=Mcap_chl)

Mcap_Chl_LMER_a_recovery <- lmer(chla.ug.cm2 ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=Mcap_chl_recovery)
Mcap_Chl_LMER_c2_recovery <- lmer(chlc2.ug.cm2 ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=Mcap_chl_recovery)

qqPlot(residuals(Mcap_Chl_LMER_a)) 
qqPlot(residuals(Mcap_Chl_LMER_c2)) 
qqPlot(residuals(Mcap_Chl_LMER_a_recovery)) 
qqPlot(residuals(Mcap_Chl_LMER_c2_recovery)) 

hist(residuals(Mcap_Chl_LMER_a)) 
hist(residuals(Mcap_Chl_LMER_c2)) 
hist(residuals(Mcap_Chl_LMER_a_recovery)) 
hist(residuals(Mcap_Chl_LMER_c2_recovery)) 

## Type III Wald chisquare tests
mcap.chl.a.anova <- Anova(Mcap_Chl_LMER_a, ddf="lme4", type='III')
mcap.chl.c2.anova <- Anova(Mcap_Chl_LMER_c2, ddf="lme4", type='III')
mcap.chl.a.anova.recovery <- Anova(Mcap_Chl_LMER_a_recovery, ddf="lme4", type='III')
mcap.chl.c2.anova.recovery <- Anova(Mcap_Chl_LMER_c2_recovery, ddf="lme4", type='III')

tab_model(Mcap_Chl_LMER_a, Mcap_Chl_LMER_c2,
...
tab_model(Mcap_Chl_LMER_a_recovery, Mcap_Chl_LMER_c2_recovery,
          dv.labels = c("M.capitata chl-a", "M.capitata chl-c2"), string.ci = "Conf. Int (95%)",
          string.p = "P-Value", file = "Output/Statistics/Chl_Mcap_Recovery.doc")

capture.output(mcap.chl.a.anova, file = "Output/Statistics/Stress_statistics/Chla_cm2_Mcap.txt")
capture.output(mcap.chl.c2.anova, file = "Output/Statistics/Stress_statistics/Chlc2_cm2_Mcap.txt")
capture.output(mcap.chl.a.anova.recovery, file = "Output/Statistics/Recovery_statistics/Chla_cm2_Mcap_recovery.txt")
capture.output(mcap.chl.c2.anova.recovery, file = "Output/Statistics/Recovery_statistics/Chlc2_cm2_Mcap_recovery.txt")
```
...
capture.output(chla.ug.cells.T, file = "Output/Statistics/Stress_statistics/Chla_cells_TTEST.txt")

chlc2.ug.cells.T <- t.test(chlc2.ug.cells~Species, data = chl.ttests)
capture.output(chlc2.ug.cells.T, file = "Output/Statistics/Stress_statistics/Chlc2_cells_TTEST.txt")

chla.ug.cm2.T <- t.test(chla.ug.cm2~Species, data = chl.ttests)
capture.output(chla.ug.cm2.T, file = "Output/Statistics/Stress_statistics/Chla_cm2_TTEST.txt")

chlc2.ug.cm2.T <- t.test(chlc2.ug.cm2~Species, data = chl.ttests)
capture.output(chlc2.ug.cm2.T, file = "Output/Statistics/Stress_statistics/Chlc2_cm2_TTEST.txt")
```
