...
model.sel(Mcap_Color_sq, Mcap_Color_sq_reef) # model selection test
...
Response: (Color.Transformed^2)
                             Chisq Df Pr(>Chisq)    
(Intercept)               410.4792  1  < 2.2e-16 ***
Blch.Time                  71.0470 15  2.906e-09 ***
Temperature                 0.0000  1     0.9997    
CO2                         0.1235  1     0.7252    
Blch.Time:Temperature     207.0771 11  < 2.2e-16 ***
Blch.Time:CO2             125.4813 15  < 2.2e-16 ***
Temperature:CO2             0.0474  1     0.8277    
Blch.Time:Temperature:CO2  50.0085 11  6.237e-07 ***
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
## significance of model
Anova(Pacuta_Color_sq_reef, ddf="lme4", type='III') # Type III Wald chisquare tests
