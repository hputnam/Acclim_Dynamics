...
```{r}
write.table(Blch, file = "Physiology_variables/Bleaching_Score.csv", append = FALSE, quote = TRUE, sep = ",",
...
## Sample Sizes 
Bleaching.Score <- read.csv("Physiology_variables/Bleaching_Score.csv", header=T, sep=",", na.string="NA") #read in data file
```

```{r}
pdf("Physiology_variables/Photographic_Bleaching.pdf")
par(mar=c(10,4,2,2)) #bottom, left, top and right margins respectively
...
Mcap.Means$Timepoint <- factor(Mcap.Means$Timepoint, levels = c("Week1", "Week2", "Week3", "Week4", "Week5", "Week6", "Week7", "Week8", "Week9", "Week10", "Week11", "Week12", "Week13", "Week14", "Week15", "Week16"))
```

```{r}
pdf("Physiology_variables/Montipora_Bleaching.pdf")
...
Pact.Means$Timepoint <- factor(Pact.Means$Timepoint, levels = c("Week1", "Week2", "Week3", "Week4", "Week5", "Week6", "Week7", "Week8", "Week9", "Week10", "Week11", "Week12", "Week13", "Week14", "Week15", "Week16"))
...
png("Physiology_variables/Poc_Bleaching.png")
