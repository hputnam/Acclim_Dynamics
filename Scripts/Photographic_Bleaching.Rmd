...
Sample.Info <- read.csv("data/Environmental/Master_Fragment.csv", header=T, sep=",", na.string="NA") #read in data file 
Sample.Info <- Sample.Info[,c(7,5,9)]
Tank.Info <- read.csv("data/Environmental/Tank_to_Treatment.csv", header=T, sep=",", na.string="NA") #read in data file 
