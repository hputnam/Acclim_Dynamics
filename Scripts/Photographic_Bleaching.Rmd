...
mcap_anova_color_score <- Anova(Mcap_Color_sq, ddf="lme4", type='III') # Type III Wald chisquare tests
#anova(Mcap_Color_sq, ddf="Satterthwaite", type='III') # Type III Analysis of Variance Table with Satterthwaite's method

capture.output(mcap_anova_color_score, file = "Output/Statistics/Colorscore_mcap_stats.txt")
```
...
## significance of model
pacuta_anova_color_score <- Anova(Pacuta_Color_sq, ddf="lme4", type='III') # Type III Wald chisquare tests
anova(Pacuta_Color_sq_reef, ddf="Satterthwaite", type='III') # Type III Analysis of Variance Table with Satterthwaite's method

capture.output(pacuta_anova_color_score, file = "Output/Statistics/Colorscore_pacuta_stats.txt")
```

```{r}
mcap_anova_color_score
pacuta_anova_color_score
```
