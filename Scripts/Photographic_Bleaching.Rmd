...
Clearing workspace and loading in required libraries. 
```{r}
...
** COME BACK AND CLEAN UP THIS SECTION ** 
```{r}
pdf("Physiology_variables/Bleaching_Intensity/Photographic_Bleaching.pdf")
par(mar=c(10,4,2,2)) #bottom, left, top and right margins respectively
...
png("Physiology_variables/Bleaching_Intensity/Bleaching_Mont.png")
print(Fig.MC, newpage = FALSE)
dev.off()
```
...
png("Physiology_variables/Bleaching_Intensity/Bleaching_Poc.png")
