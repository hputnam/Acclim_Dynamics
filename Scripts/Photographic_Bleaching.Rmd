...
```{r}
write.table(Blch, file = "Physiology_variables/Output/Bleaching_Score.csv", append = FALSE, quote = TRUE, sep = ",",
...
## Sample Sizes 
Bleaching.Score <- read.csv("Physiology_variables/Output/Bleaching_Score.csv", header=T, sep=",", na.string="NA") #read in data file
```
