...
Loading dataframes. 
```{r}
Data <- read.csv("Physiology_variables/coral_survivorship.csv", header=T, sep=",", na.string="NA", stringsAsFactors = F) #read in data file
...
```{r}
## Montipora capitata
pdf("Physiology_variables/Mcap_Survivorship.pdf")
...
## Pocillopora acuta
pdf("Physiology_variables/Pact_Survivorship.pdf")
