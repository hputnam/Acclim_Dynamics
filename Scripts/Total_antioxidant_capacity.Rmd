...
filter(QC, Plug_ID == "1724")
## output is list of samples that were run more than once; each standard should have the equal number of days run (Oct7, 14, 25, Nov10) x2 replicates
```
...
std_curve_plot5 + #plot the standard curve to check this against the protocol
  geom_point(data = Oct7, aes(x = Abs_net.adj, y = uae.mM), pch = "X", cex = 3, alpha = 0.3) +
    labs(title = "Oct 7 samples projected on Nov 10 st curve")
...
std_curve_plot5 + #plot the standard curve to check this against the protocol
  geom_point(data = Oct14, aes(x = Abs_net.adj, y = uae.mM), pch = "X", cex = 3, alpha = 0.3) +
    labs(title = "Oct 14 samples projected on Nov 10 st curve")
...
std_curve_plot5 + #plot the standard curve to check this against the protocol
  geom_point(data = Oct25, aes(x = Abs_net.adj, y = uae.mM), pch = "X", cex = 3, alpha = 0.3) +
    labs(title = "Oct 25 samples projected on Nov 10 st curve")
