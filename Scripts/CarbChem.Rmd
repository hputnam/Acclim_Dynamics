...
ggsave(file="Output/Discrete.pH.pdf", Discrete.pH, width = 9, height = 5, units = c("in"))
ggsave(file="Output/Discrete.pH.png", Discrete.pH, width = 9, height = 5, units = c("in"))
...
ggsave(filename = "Output/Total-pH-figure1.png", fig1.pH, device = "png", width = 9, height = 5)
