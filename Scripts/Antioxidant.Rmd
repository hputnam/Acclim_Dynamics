...
mcap.antiox <- antioxidant %>% subset(Species == "Mcapitata") %>% subset(Timepoint == "1 week" | Timepoint == "2 week" | Timepoint == "4 week" | Timepoint == "6 week" | Timepoint == "8 week" | Timepoint == "12 week" | Timepoint == "16 week")
...
tab_model(Pacuta_TAC_LMER, Mcap_TAC_LMER,
          dv.labels = c("P.acuta TAC", "M. capitata TAC"), string.ci = "Conf. Int (95%)",
          string.p = "P-Value", file = "Output/Statistics/TAC.doc")

capture.output(pacuta.tac.anova, file = "Output/Statistics/TAC_Pacuta.txt")
capture.output(mcap.tac.anova, file = "Output/Statistics/TAC_Mcap.txt")
```
