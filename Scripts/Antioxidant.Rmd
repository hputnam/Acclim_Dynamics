...
mcap.antiox <- antioxidant %>% subset(Species == "Mcapitata")
pacuta.antiox <- antioxidant %>% subset(Species == "Pacuta")

mcap.tac.stress <- mcap.antiox %>% subset(Timepoint == "1 week" | Timepoint == "2 week" | Timepoint == "4 week" | Timepoint == "6 week" | Timepoint == "8 week")
pacuta.tac.stress <- pacuta.antiox %>% subset(Timepoint == "1 week" | Timepoint == "2 week" | Timepoint == "4 week" | Timepoint == "6 week" | Timepoint == "8 week")

mcap.tac.recovery <- mcap.antiox %>% subset(Timepoint == "10 week" | Timepoint == "12 week" | Timepoint == "14 week" | Timepoint == "16 week")
pacuta.tac.recovery <- pacuta.antiox %>% subset(Timepoint == "10 week" | Timepoint == "12 week" | Timepoint == "14 week" | Timepoint == "16 week") %>% subset(Treatment == "ATAC" | Treatment == "ATHC")

hist(mcap.tac.stress$cre.umol.mgprot) 
hist(pacuta.tac.stress$cre.umol.mgprot) 

hist(mcap.tac.recovery$cre.umol.mgprot) 
hist(pacuta.tac.recovery$cre.umol.mgprot) 
```
...
Pacuta_TAC_LMER_stress <- lmer(log(cre.umol.mgprot) ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=pacuta.tac.stress) 
Pacuta_TAC_LMER_recovery <- lmer(log(cre.umol.mgprot) ~ Timepoint*CO2 + (1|Tank), na.action=na.omit, data=pacuta.tac.recovery) 

qqPlot(residuals(Pacuta_TAC_LMER)) 
qqPlot(residuals(Pacuta_TAC_LMER_stress)) 
qqPlot(residuals(Pacuta_TAC_LMER_recovery)) 

hist(residuals(Pacuta_TAC_LMER)) 
hist(residuals(Pacuta_TAC_LMER_stress)) 
hist(residuals(Pacuta_TAC_LMER_recovery)) 

## Type III Wald chisquare tests
pacuta.tac.anova <- Anova(Pacuta_TAC_LMER, ddf="lme4", type='III')
pacuta.tac.anova.stress <- Anova(Pacuta_TAC_LMER_stress, ddf="lme4", type='III')
pacuta.tac.anova.recovery <- Anova(Pacuta_TAC_LMER_recovery, ddf="lme4", type='III')

capture.output(pacuta.tac.anova, file = "Output/Statistics/tac_stats_pacuta.txt")
capture.output(pacuta.tac.anova.stress, file = "Output/Statistics/tac_stats_pacuta_stress.txt")
capture.output(pacuta.tac.anova.recovery, file = "Output/Statistics/tac_stats_pacuta_recovery.txt")
```
...
Mcap_TAC_LMER_stress <- lmer(log(cre.umol.mgprot) ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=mcap.tac.stress) 
Mcap_TAC_LMER_recovery <- lmer(log(cre.umol.mgprot) ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=mcap.tac.recovery) 

qqPlot(residuals(Mcap_TAC_LMER))
qqPlot(residuals(Mcap_TAC_LMER_stress))
qqPlot(residuals(Mcap_TAC_LMER_recovery))

hist(residuals(Mcap_TAC_LMER)) 
hist(residuals(Mcap_TAC_LMER_stress)) 
hist(residuals(Mcap_TAC_LMER_recovery)) 

## Type III Wald chisquare tests
mcap.tac.anova <- Anova(Mcap_TAC_LMER, ddf="lme4", type='III')
mcap.tac.anova.stress <- Anova(Mcap_TAC_LMER_stress, ddf="lme4", type='III')
mcap.tac.anova.recovery <- Anova(Mcap_TAC_LMER_recovery, ddf="lme4", type='III')

capture.output(mcap.tac.anova, file = "Output/Statistics/tac_stats_mcap.txt")
capture.output(mcap.tac.anova.stress, file = "Output/Statistics/tac_stats_mcap_stress.txt")
capture.output(mcap.tac.anova.recovery, file = "Output/Statistics/tac_stats_mcap_recovery.txt")
```
