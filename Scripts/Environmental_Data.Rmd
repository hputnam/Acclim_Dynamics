...
Hobo.means <- summarySE(Hobo.data.filtered, measurevar = "Temperature", groupvars=c("Date.Time", "Treatment")) #N, mean(Temperature), sd, se, ci
```
...
ggsave(filename = "Output/Hobo-loggers-parsed.pdf", device = "pdf", width = 11, height = 8)
ggsave(filename = "Output/Hobo-loggers-parsed.png", device = "png", width = 11, height = 8)
```
