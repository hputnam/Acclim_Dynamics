...
write_csv(path = "Environmental_data/HOBO-Temperature-Treatment.csv", Hobo.treatment)
write_csv(path = "Environmental_data/HOBO-Temperature-Date.csv", Hobo.date)
```
...
ggsave(filename = "Output/Hobo-loggers-figure1.png", fig1, device = "png", width = 9, height = 5)
```
