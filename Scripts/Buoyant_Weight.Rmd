...
Growth_facetplot.m <- ggplot(All.Means.m, aes(x=TimePoint, y = mg.d.cm2, group = Treatment, color = Treatment)) +
  geom_line() + geom_point() +
...
mcap_anova_growth_stress <- Anova(Mcap_Growth_LMER_tank_plug_stress, ddf="lme4", type='III')
...
capture.output(mcap_anova_growth_stress, file = "Output/Statistics/BW_stats_mcap_stress.txt")
