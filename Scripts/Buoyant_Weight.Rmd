...
Calc_plot <- ggplot(All.Means, aes(x=week, y = mg.d.cm2, group = Treatment, color = Treatment)) +
  ...
  # Change axis line
  axis.line = element_line(colour = "black")); Calc_plot

ggsave(file="Output/Final_Figures/Calacification.pdf", Calc_plot, width = 11, height = 6, units = c("in"))
ggsave(file="Output/Final_Figures/Calacification.png", Calc_plot, width = 11, height = 6, units = c("in"))
```
