...
ggsave(file="Output/Final_Figures/OLD-GOLD-Host-Soluble-Protein.pdf", PROT, width = 11, height = 6, units = c("in"))
ggsave(file="Output/Final_Figures/OLD-GOLD-Host-Soluble-Protein.png", PROT, width = 11, height = 6, units = c("in"))
```
