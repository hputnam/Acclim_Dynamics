...
```{r}
## All points projected on Nov 10 standard curve plot (std_curve_plotNov10) ; standard curve 5 (Nov10_st) ; linear model 5 (TAC_mod_linNov10)
...
ggsave(file="Output/Final_Figures/TAC-values.png", TAC.values, width = 8, height = 5, units = c("in"))
