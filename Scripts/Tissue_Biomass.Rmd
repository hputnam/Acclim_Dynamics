...
AFDW.cells <- AFDW %>% select(-X) %>% distinct() %>% 
  ...
  spread(partner, AFDW.mg.cells) #%>% gather("partner", "value", 7:9) %>% na.omit()
...
biomass.ttests <- union(biomass.mcap, biomass.pacuta)
```
...
Mcap_Host_recovery_LMER <- lmer((Host) ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=biomass.mcap.recovery) 
...
tab_model(Pacuta_Host_LMER, Mcap_Host_LMER, Mcap_Host_recovery_LMER,
          dv.labels = c("P.acuta Host", "M.cap Host Stress", "M.cap Recovery period"), string.ci = "Conf. Int (95%)",
          string.p = "P-Value", file = "Output/Statistics/AFDW_Host.doc")

capture.output(pacuta.host.anova, file = "Output/Statistics/Stress_statistics/AFDW_Host_Pacuta.txt")
capture.output(mcap.host.anova, file = "Output/Statistics/Stress_statistics/AFDW_Host_Mcap.txt")
capture.output(spp.host.anova, file = "Output/Statistics/Stress_statistics/AFDW_Host.txt")
...
capture.output(species.t, file = "Output/Statistics/Stress_statistics/AFDW_Host_TTEST.txt")
```
...
Mcap_Sym_recovery_LMER <- lmer(Sym ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=biomass.mcap.recovery) 

qqPlot(residuals(Pacuta_Sym_LMER)) 
qqPlot(residuals(Mcap_Sym_LMER)) 
qqPlot(residuals(Mcap_Sym_recovery_LMER)) 

hist(residuals(Pacuta_Sym_LMER)) 
hist(residuals(Mcap_Sym_LMER)) 
hist(residuals(Mcap_Sym_recovery_LMER)) 

## Type III Wald chisquare tests
pacuta.sym.anova <- Anova(Pacuta_Sym_LMER, ddf="lme4", type='III') 
mcap.sym.anova <- Anova(Mcap_Sym_LMER, ddf="lme4", type='III') 
mcap.sym.recovery.anova <- Anova(Mcap_Sym_recovery_LMER, ddf="lme4", type='III') 

tab_model(Pacuta_Sym_LMER, Mcap_Sym_LMER, Mcap_Sym_recovery_LMER,
          dv.labels = c("P.acuta Sym", "M.cap Sym Stress", "M.cap Sym Recovery"), string.ci = "Conf. Int (95%)",
          string.p = "P-Value", file = "Output/Statistics/AFDW_Sym.doc")

capture.output(pacuta.sym.anova, file = "Output/Statistics/Stress_statistics/AFDW_Sym_Pacuta.txt")
capture.output(mcap.sym.anova, file = "Output/Statistics/Stress_statistics/AFDW_Sym_Mcap.txt")
capture.output(mcap.sym.recovery.anova, file = "Output/Statistics/Recovery_statistics//AFDW_Sym_Mcap_Recovery.txt")

species.t.sym <- t.test(Sym~Species, data = biomass.ttests)
capture.output(species.t.sym, file = "Output/Statistics/Stress_statistics/AFDW_Sym_TTEST.txt")
```
...
AFDW.cells.ttest <- union(AFDW.cells.pacuta, AFDW.cells.mcap)

Pacuta_Sym_LMER_cells <- lmer(Sym ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=AFDW.cells.pacuta) 
Mcap_Sym_LMER_cells <- lmer(Sym ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=AFDW.cells.mcap) 
Mcap_Sym_recovery_LMER_cells <- lmer(Sym ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=AFDW.cells.mcap.recovery) 
...
tab_model(Pacuta_Sym_LMER_cells, Mcap_Sym_LMER_cells, Mcap_Sym_recovery_LMER_cells,
          dv.labels = c("P.acuta Sym", "M.cap Sym Stress", "M.cap Sym Recovery"), string.ci = "Conf. Int (95%)",
          string.p = "P-Value", file = "Output/Statistics/AFDW_Sym_cells.doc")

capture.output(pacuta.cells.sym.anova, file = "Output/Statistics/Stress_statistics/AFDW_Sym_cells_Pacuta.txt")
capture.output(mcap.cells.sym.anova, file = "Output/Statistics/Stress_statistics/AFDW_Sym_cells_Mcap.txt")
...
capture.output(species.t.sym.cells, file = "Output/Statistics/Stress_statistics/AFDW_Sym_cells_TTEST.txt")
```
...
Mcap_Ratio_LMER_recovery <- lmer(Ratio_S.H ~ Timepoint*Temperature*CO2 + (1|Tank), na.action=na.omit, data=biomass.mcap.recovery) 
...
tab_model(Pacuta_Ratio_LMER, Mcap_Ratio_LMER, Mcap_Ratio_LMER_recovery,
          dv.labels = c("P.acuta Ratio", "M.cap Ratio Stress", "M.cap Ratio Recovery"), string.ci = "Conf. Int (95%)",
          string.p = "P-Value", file = "Output/Statistics/AFDW_Ratio.doc")

capture.output(pacuta.ratio.anova, file = "Output/Statistics/Stress_statistics/AFDW_Ratio_Pacuta.txt")
capture.output(mcap.ratio.anova, file = "Output/Statistics/Stress_statistics/AFDW_Ratio_Mcap.txt")
...
capture.output(species.t.ratio, file = "Output/Statistics/Stress_statistics/AFDW_Ratio_TTEST.txt")
```
