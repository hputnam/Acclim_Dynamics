...
Master_fragment <- read.csv("Environmental_data/Master_Fragment_20200616_QC.csv") %>%
  select(Plug_ID, Species, Treatment, Sample.Date)
...
AFDW_final <- AFDW %>% select(Plug_ID, partner, Species, Treatment, Sample.Date, Day_Number, DW.mg.cm2, AFDW.mg.cm2) %>%
...
AFDW_means_dayno <- summarySE(AFDW_final, measurevar="Value", groupvars=c("partner", "Day_Number", "Treatment", "Species", "Measurement")) %>%
  subset(Measurement=="AFDW.mg.cm2")
AFDW_means_dayno

AFDW_means_date <- summarySE(AFDW_final, measurevar="Value", groupvars=c("partner", "Sample.Date", "Treatment", "Species", "Measurement")) %>%
  subset(Measurement=="AFDW.mg.cm2")
AFDW_means_date
```
