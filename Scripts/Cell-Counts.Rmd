...
```{r}
mcap.counts <- haemo %>% subset(Species == "Montipora capitata") %>% subset(Timepoint == "1 week" | Timepoint == "2 week" | Timepoint == "4 week" | Timepoint == "6 week" | Timepoint == "8 week" | Timepoint == "12 week" | Timepoint == "16 week")
...
tab_model(Pacuta_counts_LMER, Mcap_counts_LMER,
          dv.labels = c("P.acuta cell counts", "M. cap cell counts"), string.ci = "Conf. Int (95%)",
          string.p = "P-Value", file = "Output/Statistics/Counts.doc")

capture.output(pacuta.counts.anova, file = "Output/Statistics/Counts_Pacuta.txt")
capture.output(mcap.counts.anova, file = "Output/Statistics/Counts_Mcap.txt")
```
