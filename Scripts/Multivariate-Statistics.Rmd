...
Columns 10:21 are the data values columns. Columns 1-9 are metadata. 
...
stress.fig.trt.pacuta <- ggplot(stress.pacuta.means.trt, aes(.fittedPC1, .fittedPC2, group = Treatment)) + 
  ...
  theme(legend.title = element_text(size=11, face="bold")) +
  theme(legend.text = element_text(size=9)) +
  scale_color_manual(values = c("blue", "lightblue", "salmon", "red"), aesthetics = c("colour")) 
...
stress.fig.trt.mcap <- ggplot(stress.mcap.means.trt, aes(.fittedPC1, .fittedPC2, group = Treatment)) + 
  ...
  theme(legend.text = element_text(size=9)) +
  scale_color_manual(values = c("blue", "lightblue", "salmon", "red"), aesthetics = c("colour")) +
  scale_fill_manual(values = c("blue", "lightblue", "salmon", "red"), aesthetics = c("colour2")) 

ggsave(file="Output/Supplemental_figures/PCA-trt-timearrows-Mcap.png", stress.fig.trt.mcap, width = 7, height = 7, units = c("in"))
ggsave(file="Output/Supplemental_figures/PCA-trt-timearrows-Pacuta.png", stress.fig.trt.pacuta, width = 7, height = 7, units = c("in"))
```
...
biplot.trt.mcap <- autoplot(stress_mcap_scaled, data = stress.mcap.means.trt, colour = 'Treatment', 
  ...
  scale_color_manual(values = c("blue", "lightblue", "salmon", "red")) + 
...
ggsave(file="Output/Supplemental_figures/PCA-biplot-trt-Mcap.png", biplot.trt.mcap, width = 7, height = 7, units = c("in"))
...
ggsave(file="Output/Supplemental_figures/PCA-biplot-trt-Pacuta.png", biplot.trt.pacuta, width = 7, height = 7, units = c("in"))
```
...
ggsave(file="Output/Manuscript_figures/PCA-Recovery-biplot.png", mcap.recovery.biplot, width = 7, height = 7, units = c("in"))
```

```{r}
mcap.recovery.fig <- ggplot(mcap.means, aes(.fittedPC1, .fittedPC2, color = Treatment)) + 
