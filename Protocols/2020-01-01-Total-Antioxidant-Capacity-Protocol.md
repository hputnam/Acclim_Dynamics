...
1. Using a pipette, mix the sample in the microcentrifuge tube. Add 20 μL of the diluted Uric Acid Standards or samples to the 96-well microtiter plate. Vortex samples and standards prior to adding to the well.    
...
The script used to analyze these data can be found [here](https://github.com/hputnam/Acclim_Dynamics/blob/master/Scripts/Total_antioxidant_capacity.Rmd).
